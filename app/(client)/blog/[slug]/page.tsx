    ...
    <div className="py-10">
      <Container className="grid grid-cols-1 lg:grid-cols-4 gap-5">
        <div className="md:col-span-3 text-gray-300">
          ...
          <div>
            <div className="text-xs flex items-center gap-5 my-7 text-gray-300">
              ...
              <p className="flex items-center gap-1 text-gray-300 relative group hover:cursor-pointer hover:text-shop_dark_green hoverEffect">
                    ...
                    <PortableText
                      ...
                      components={{
                        block: {
                          ...
                          h2: ({ children }) => (
                            <h2 className="my-5 text-2xl/8 font-medium tracking-tight text-gray-500 first:mt-0 last:mb-0">
                              {children}
                            </h2>
                          ),
                          h3: ({ children }) => (
                            <h3 className="my-5 text-xl/8 font-medium tracking-tight text-gray-500 first:mt-0 last:mb-0">
                              {children}
                            </h3>
                          ),
                          blockquote: ({ children }) => (
                            <blockquote className="my-5 border-l-2 border-l-gray-300 pl-6 text-base/8 text-gray-300 first:mt-0 last:mb-0">
                              {children}
                            </blockquote>
                          ),
                        },
                        ...
                        marks: {
                          ...
                          code: ({ children }) => (
                            <>
                              ...
                              <code className="text-[15px]/8 font-semibold text-gray-400">
                                {children}
                              </code>
                              <span aria-hidden>`</span>
                            </>
                          ...
                          link: ({ value, children }) => (
                            <Link
                              href={value.href}
                              className="font-medium text-gray-400 underline decoration-gray-400 underline-offset-4 data-[hover]:decoration-gray-600"
                            >
                              {children}
                            </Link>
                          ),
...
const BlogLeft = async ({ slug }: { slug: string }) => {
  ...
  return (
    <div>
      <div className="border border-lightColor p-5 ">
        <Title className="text-base">Blog Categories</Title>
        <div className="space-y-2 mt-2">
          {categories?.map(({ blogcategories }, index) => (
            <div
              key={index}
              className="text-gray-400 flex items-center justify-between text-sm font-medium"
            >
      ...
      <div className="border border-lightColor p-5 mt-10">
        ...
        <div className="space-y-4 mt-4">
          {blogs?.map((blog, index: number) => (
            ...
            >
              ...
              <p className="line-clamp-2 text-sm text-gray-300 group-hover:text-shop_dark_green hoverEffect">
                {blog.title}
              </p>
            </Link>
          ))}
